    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ perspective: "1000px" }}>
      ...
      >
        ...
        >
          ...
          <p className="text-md md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto font-light text-left sm:text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-center items-stretch sm:items-center mb-12">
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass-effect px-8 py-4 rounded-md text-lg font-semibold hover:bg-white/10 dark:hover:bg-white/10 hover:bg-blue-50 dark:hover:bg-white/10 transition-all card-hover flex items-center justify-center space-x-2 w-full sm:w-auto"
